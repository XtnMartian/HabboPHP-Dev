...
while($row2=mysql_fetch_array($query2)) $notes.='<div class="movable stickie '.safe($row2['color'],'HTML').'-c" id="note-'.$row2['id'].'" rel="'.$row2['id'].'" wtype="note" style="left: '.$row2['x'].'px; top: '.$row2['y'].'px; z-index: '.$row2['z'].';" id="stickie-'.$row2['id'].'">
	...
	<img src="'.$config->url_site.'/images/icon_edit.gif" width="19" height="18" onclick="/*var mtop=\'-\'+$(\'#note-'.$row2['id'].'\').height();$(\'#edit-'.$row2['id'].'\').css(\'marginLeft\',$(\'#note-'.$row2['id'].'\').width());$(\'#edit-'.$row2['id'].'\').css(\'marginTop\',mtop);*/$(\'#edit-'.$row2['id'].'\').toggle();" class="edit-button" id="sticker-'.$row2['id'].'-edit">
...
while($roomsr=mysql_fetch_array($roomsq)) { 
	...
	if($roomsr['state']) $close='<img src="images/room_icon_locked.gif" alt="" align="middle">';
	else $close='<img src="images/room_icon_open.gif" alt="" align="middle">';
	$rooms.='<tr>
...
while($roww=mysql_fetch_array($queryw)) {
	...
	else $status='<img alt="offline" src="images/habbo_offlineB.gif" />';
...
<div class="'.$roww['profilstyle'].'" id="cwidget-profil-'.$roww['id'].'">
	<div class="widget-corner" id="widget-8083060-handle">
		<div class="widget-headline"><h3><span class="header-left">&nbsp;</span><span class="header-middle">'.$tpl->getConfigVars('MyProfil').'</span><span class="header-right">&nbsp;</span></h3>
			<img src="'.$config->url_site.'/images/icon_edit.gif" width="19" height="18" onclick="$(\'#edit-profil-'.$roww['id'].'\').toggle();" class="edit-button" id="sticker-profil-'.$roww['id'].'-edit" style="z-index:9999">
	...
	<div class="profile-figure">
			<img alt="" src="http://www.habbo.com/habbo-imaging/avatarimage?figure='.$lookhome.'&direction=4" />
	</div>
...
<div class="'.$roww['badgesstyle'].'" id="cwidget-badges-'.$roww['id'].'">
	<div class="widget-corner" id="widget-7958056-handle">
		...
		<img src="'.$config->url_site.'/images/icon_edit.gif" width="19" height="18" onclick="$(\'#edit-badges-'.$roww['id'].'\').toggle();" class="edit-button" id="sticker-badges-'.$roww['id'].'-edit" style="z-index:9999">
...
<div class="'.$roww['playerstyle'].'" id="cwidget-player-'.$roww['id'].'">
	...
	<img src="'.$config->url_site.'/images/icon_edit.gif" width="19" height="18" onclick="$(\'#edit-player-'.$roww['id'].'\').toggle();" class="edit-button" id="sticker-player-'.$roww['id'].'-edit" style="z-index:9999">
	<div style="z-index:999999999;position:absolute;display:none;background:#eee;border:1px solid #000;border-bottom:2px solid #000;padding:10px;margin-left:280px;width:100px;-moz-border-radius:5px;-webkit-border-radius:5px;border-radius:5px;" id="edit-player-'.$roww['id'].'">
		...
		<div class="widget-headline"><h3><span class="header-left">&nbsp;</span><span class="header-middle">'.$tpl->getConfigVars('Traxplayer').'</span><span class="header-right">&nbsp;</span></h3><img src="images/icon_edit.gif" width="19" height="18" class="edit-button" id="widget-5234462-edit">
		</div>	
	</div>
	<div class="widget-body">
		<div class="widget-content">
...
<div class="'.safe($roww['roomsstyle'],'HTML').'" id="cwidget-rooms-'.$roww['id'].'">
	<div class="widget-corner" id="widget-7961919-handle">
		<div class="widget-headline"><h3>
	<img src="'.$config->url_site.'/images/icon_edit.gif" width="19" height="18" onclick="$(\'#edit-rooms-'.$roww['id'].'\').toggle();" class="edit-button" id="sticker-rooms-'.$roww['id'].'-edit" style="z-index:9999">
...
<div class="'.$roww['booksstyle'].'" id="cwidget-books-'.$roww['id'].'">
	<div class="widget-corner" id="widget-7964878-handle">
		<div class="widget-headline"><h3>
	<img src="'.$config->url_site.'/images/icon_edit.gif" width="19" height="18" onclick="$(\'#edit-books-'.$roww['id'].'\').toggle();" class="edit-button" id="sticker-books-'.$roww['id'].'-edit" style="z-index:9999">
...
<div class="'.$roww['groupsstyle'].'" id="cwidget-groups-'.$roww['id'].'">
	<div class="widget-corner" id="widget-7965772-handle">
		<div class="widget-headline"><h3>
	<img src="'.$config->url_site.'/images/icon_edit.gif" width="19" height="18" onclick="$(\'#edit-groups-'.$roww['id'].'\').toggle();" class="edit-button" id="sticker-groups-'.$roww['id'].'-edit" style="z-index:9999">
...
<div class="'.$roww['friendsstyle'].'" id="cwidget-friends-'.$roww['id'].'">
	<div class="widget-corner" id="widget-7966448-handle">
		<div class="widget-headline"><h3>
	<img src="'.$config->url_site.'/images/icon_edit.gif" width="19" height="18" onclick="$(\'#edit-friends-'.$roww['id'].'\').toggle();" class="edit-button" id="sticker-friends-'.$roww['id'].'-edit" style="z-index:9999">
