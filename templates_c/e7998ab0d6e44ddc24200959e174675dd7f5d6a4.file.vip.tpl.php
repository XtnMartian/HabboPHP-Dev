...
<a href="javascript:void(0);" id="buttonn" onclick="jQuery('#ok').animate({opacity:0}, function() {jQuery('#okt').slideUp('slow',function(){ jQuery('#go').slideDown('slow',function(){ jQuery('#go').animate({opacity:1}); jQuery('.bigbulle').animate({opacity:0}, function() {jQuery('.bigbulle').slideUp('fast',function() { jQuery('#goc').slideDown('fast',function() { jQuery('#goc').animate({opacity:1}); }); });}); }); });});" style="text-decoration:none;"><div class="bigbulle">
	Adhère au VIP club !
</div></a>
				...
				<div class="habblet-container" style="opacity:0;display:none;width:764px;" id="go">		
					...
					<div id="valideok" style="padding:10px;font-size:18px;display:none;opacity:0;background:#60b200;color:white;text-shadow:0 1px 0 #407700;-moz-border-radius:10px;-webkit-border-radius:10px;border-radius:10px;margin:20px;"></div>
						<div class='box-content' id="goc" style="display:none;opacity:0;">
							...
							<div id="slider-result">6 mois = <?php echo $_smarty_tpl->tpl_vars['config']->value->vipprice*6;?>
