...
echo '<script>$("#adminform").animate({opacity:0}).slideUp("slow",function(){$("#okadmin").slideDown("slow").animate({opacity:1});});</script><div style="opacity:0;display:none;" id="okadmin"><font lang="en">It\'s terminate!<br />Please delete the /install folder !<br /><br />C\'est termin&eacute;!<br />Veuillez supprimer le dossier /install</font><br /><br /><br /><a href="'.$config->url_site.'" class="downloadButton" lang="en">Go!</a></div>';}else exit();
