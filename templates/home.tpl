...
<link rel="stylesheet" href="{$config->url_site}/assets/css/hp_images.php" type="text/css" media="screen" />
<link rel="stylesheet" href="{$config->url_site}/assets/css/hp_backgrounds.php" type="text/css" media="screen" />
<script type="text/javascript" src="{$config->url_site}/assets/js/jquery.nyroModal.custom.js"></script>
