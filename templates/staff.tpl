...
<img id="f1" src="http://www.habbo.com/habbo-imaging/avatarimage?figure={$item.look}&direction=0&head_direction=0&gesture=std&size=l&img_format=gif" class="active" />
<img id="f2" src="http://www.habbo.com/habbo-imaging/avatarimage?figure={$item.look}&direction=1&head_direction=1&gesture=std&size=l&img_format=gif" />
<img id="f3" src="http://www.habbo.com/habbo-imaging/avatarimage?figure={$item.look}&direction=2&head_direction=2&gesture=std&size=l&img_format=gif" />
<img id="f4" src="http://www.habbo.com/habbo-imaging/avatarimage?figure={$item.look}&direction=3&head_direction=3&gesture=std&size=l&img_format=gif" />
<img if="f5" src="http://www.habbo.com/habbo-imaging/avatarimage?figure={$item.look}&direction=4&head_direction=4&gesture=std&size=l&img_format=gif" />
<img id="f6" src="http://www.habbo.com/habbo-imaging/avatarimage?figure={$item.look}&direction=5&head_direction=5&gesture=std&size=l&img_format=gif" />
<img id="f7" src="http://www.habbo.com/habbo-imaging/avatarimage?figure={$item.look}&direction=6&head_direction=6&gesture=std&size=l&img_format=gif" />
<img id="f8" src="http://www.habbo.com/habbo-imaging/avatarimage?figure={$item.look}&direction=7&head_direction=7&gesture=std&size=l&img_format=gif" />
</div>
